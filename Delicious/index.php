...
?>
  ...
  <main class="main">
    ...
    <!-- Menu Section -->
    <?php include 'app/views/sections/menu_section.php'; 
    ?>
    ...
    <!-- Chefs Section -->
    <?php include 'app/views/sections/karyawan_section.php'; 
    ?>
    ...
    <div class="container">
      <div class="row gy-3">
        <div class="col-lg-3 col-md-6 d-flex">
          ...
          <div class="address">
            <h4>Address</h4>
            <p>Jl. Warujayeng - Kediri</p>
            <p>Kampungbaru, Kec. Tanjunganom, Kabupaten Nganjuk, Jawa Timur 64482
</p>
            <p></p>
          </div>
        ...
        <div class="col-lg-3 col-md-6 d-flex">
          ...
          <div>
            <h4>Contact</h4>
            <p>
              <strong>Phone:</strong> <span>+62 8129-0966-363</span><br>
              <strong>Email:</strong> <span>@seblakprasmanansaycafe</span><br>
            </p>
          </div>
        </div>
        ...
        <div class="col-lg-3 col-md-6 d-flex">
          ...
          <div>
            <h4>Opening Hours</h4>
            <p>
              <strong>Everyday:</strong> <span>10:00 AM - 22:00 PM</span><br>
            </p>
          </div>
        </div>
